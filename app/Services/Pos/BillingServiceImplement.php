 ...
 */
class BillingServiceImplement implements BillingServiceInterface
{
    public function __construct(private readonly TableTurnoverServiceInterface $turnover) {}
    ...
    {
        if (! in_array($method, PaymentServiceInterface::METHOD_OPTIONS, true)) {
