...
<div class="relative" x-data="{ show: false }">
    ...
    <button type="button" tabindex="-1" x-on:click="show = !show"
        class="absolute inset-y-0 end-0 flex items-center px-3 text-base-content/40 transition hover:text-primary focus:outline-none focus-visible:text-primary"
