<nav class="fixed inset-x-0 bottom-0 z-40 border-t border-stone-200 bg-white/95 backdrop-blur md:hidden">
    <ul class="mx-auto grid w-full max-w-6xl grid-cols-5 text-xs font-semibold">
        ...
        <li>
            <a href="{{ route('customer.menus.tables') }}" class="flex flex-col items-center gap-1 py-3 {{ request()->routeIs('customer.menus.tables') ? 'text-emerald-700' : 'text-stone-500' }}">
                <i class="ri-layout-grid-line text-lg"></i>
                <span>Meja</span>
            </a>
        </li>
        <li>
            <a href="{{ route('customer.menus.index') }}" class="flex flex-col items-center gap-1 py-3 {{ request()->routeIs('customer.menus.index') ? 'text-emerald-700' : 'text-stone-500' }}">
        ...
        <li>
            <a href="{{ route('profile') }}" class="flex flex-col items-center gap-1 py-3 {{ request()->routeIs('profile') ? 'text-emerald-700' : 'text-stone-500' }}">
