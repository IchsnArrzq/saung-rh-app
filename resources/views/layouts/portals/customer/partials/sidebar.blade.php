            ...
            <ul class="menu w-full gap-1 p-0">
                <li>
                    <a href="{{ route('customer.dashboard') }}"
                        class="{{ request()->routeIs('customer.dashboard') ? 'active bg-primary text-primary-content' : 'text-base-content hover:bg-base-300' }}">
                ...
                <li>
                    <a href="{{ route('customer.menus.tables') }}"
                        class="{{ request()->routeIs('customer.menus.tables') ? 'active bg-primary text-primary-content' : 'text-base-content hover:bg-base-300' }}">
                ...
                <li>
                    <a href="{{ route('customer.menus.index') }}"
                        class="{{ request()->routeIs('customer.menus.index') ? 'active bg-primary text-primary-content' : 'text-base-content hover:bg-base-300' }}">
