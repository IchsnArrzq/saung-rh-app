...
<body class=" bg-neutral text-base-content antialiased">
    {{-- Tanpa shadow: tema ini --depth:0, dan pemisahan datang dari base-100 di atas latar halaman. --}}
    <main class="grid min-h-screen w-full bg-base-100 md:grid-cols-[1fr_1.1fr]">
        ...
        <aside class="relative hidden overflow-hidden md:block">
            ...
            {{-- check-ui-allow: teks & scrim di atas foto, bukan di atas permukaan tema — token base-content justru hilang di sini. --}}
            <div class="relative flex h-full flex-col justify-end gap-8 p-12 text-white">
                <div>
                    ...
                    {{-- check-ui-allow: masih di atas foto yang sama. --}}
                ...
                <ul class="space-y-4">
                    @foreach ([
                        ...
                        <li class="flex items-center gap-3">
                            {{-- check-ui-allow: kaca buram di atas foto. --}}
                            ...
                            {{-- check-ui-allow: teks di atas foto. --}}
