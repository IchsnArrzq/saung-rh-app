<div>
    ...
    {{-- Header --}}
    <x-page-header title="Katalog Menu">
        ...
        <x-slot:actions>
            <x-button variant="ghost" size="sm" icon="ri-refresh-line"
        ...
        <div @class([
            ...
            <div class="flex flex-wrap items-center gap-2">
                <x-button size="sm" wire:click="setCategory()"
                    ...
                    Semua
                    <x-badge size="sm" class="tabular-nums">{{ $totalAvailable }}</x-badge>
                </x-button>
            ...
            <aside class="xl:col-span-5 xl:sticky xl:top-4">
                <x-card>
                    ...
                    <div class="mt-4 border-t border-base-300 pt-4">
                        <x-textarea label="Catatan untuk dapur (opsional)" name="orderNotes" :rows="2" size="sm"
                            wire:model="orderNotes" placeholder="contoh: utamakan menu tanpa pedas" />
                        ...
                        <x-button variant="primary" :block="true" class="mt-4" icon="ri-send-plane-2-line"
        ...
        @if ($selectedMenu)
            <div class="space-y-4">
                ...
                <div class="grid gap-3 sm:grid-cols-[auto_1fr] sm:items-end">
                    <x-input label="Jumlah" name="detailQty" type="number" size="sm" min="1" max="50"
                        wire:model="detailQty" />
                    <x-input label="Catatan item (opsional)" name="detailNotes" size="sm" maxlength="255"
                        wire:model="detailNotes" placeholder="contoh: tanpa es" />
                </div>

                <x-button variant="primary" :block="true" icon="ri-add-line" wire:click="addFromDetail">
                    Tambah ke Pesanan
                </x-button>
            </div>
        @endif
