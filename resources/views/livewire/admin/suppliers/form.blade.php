        ...
        <div class="grid gap-4 md:grid-cols-2">
            ...
            <fieldset class="fieldset">
                ...
                <input type="text" class="input input-bordered w-full" wire:model.defer="code"
                    placeholder="Opsional, mis. SUP-001">
                @error('code')
                    <p class="label text-error">{{ $message }}</p>
                @enderror
            </fieldset>
            ...
            <fieldset class="fieldset">
                <legend class="fieldset-legend">Nama Kontak (PIC)</legend>
                <input type="text" class="input input-bordered w-full" wire:model.defer="contact_person">
            ...
            <fieldset class="fieldset md:col-span-2">
                ...
                <label class="label cursor-pointer justify-start gap-3 px-0">
                    ...
                    <span class="label-text">Supplier aktif</span>
                </label>
            </fieldset>
        </div>
